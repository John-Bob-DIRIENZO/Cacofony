...
<div class="mt-5 md:mt-0 md:col-span-2">
  <form method="POST" action="/post/<?= 1 ?>/create">
      ...
      <div class="px-4 py-5 bg-white sm:p-6">
        <div class="grid grid-cols-6 gap-6">
          ...
          <div class="col-span-6 sm:col-span-3">
            ...
            <input required type="text" name="title" id="title" placeholder="Mon titre" class="px-2 h-10 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md">
          </div>
          <!-- IMAGE -->
          <div class="col-span-6 sm:col-span-3">
            <label for="image" class="block text-sm font-medium text-gray-700">Lien de l'image</label>
            <input required type="text" name="image" id="image" placeholder="Mon lien" class="px-2 h-10 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md">
          </div>
        </div>
